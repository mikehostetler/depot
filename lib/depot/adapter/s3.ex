...
#     path = clean_path(Depot.Path.join_prefix(config.prefix, path))
...
#     source = clean_path(Depot.Path.join_prefix(source_config.prefix, source))
#     destination = clean_path(Depot.Path.join_prefix(dest_config.prefix, destination))
...
#     base_path = clean_path(Depot.Path.join_prefix(config.prefix, path))
